...
# Suiz_lt 2/3 : 1/3: waren sie schon jemals suizidal?
# SV_lifetime - ob schonmal ein suizidversuch begannen oder ob nicht?
# suizid_aktuel - sind sie akltuell suizidal? ja/nein 
# 
# 
# 
# #  Fragen zu Fragebögen
# was sind die AMDP T-Werte: zusammenfassung der einzelnen 
# PSSI-T-Werte: wo sind die Rohwerte?
# wie mit den zwei Missingszeilen umgehen? FIML, MI?
# VISCI: östereichisches Instrument zu Risikofaktoren - zusammengefasst in ein ampelsystem
